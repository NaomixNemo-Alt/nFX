"use strict"; const Path = require ("../func/path.js").main; const File = require ("./File.js").main; const Folder = require ("./Folder.js").main;
...
class Base {
  constructor (path, options = { resolve: true }) {
    ...
    if (this.constructor.name == "Base") this.promise = true;
